  ...
  return (
    <>
      <div className="bg-gray-100 flex sm:flex-col md:flex-col flex-row font-bramptonserifregulardemo sm:gap-5 md:gap-5 items-start mx-auto w-full">
        <Sidebar1 className="!sticky !w-[356px] bg-white-A700 flex h-screen md:hidden justify-start overflow-auto md:px-5 rounded-br-[24px] rounded-tr-[24px] shadow-bs1 top-[0]" />
        <div className="flex flex-1 font-nunitosans h-[1024px] md:h-[1609px] justify-end md:px-5 relative w-full">
          <div className="flex flex-col gap-[18px] h-full items-start justify-start mb-8 mt-auto mx-auto w-[94%]">
            <Text
                  ...
                  <div className="flex flex-col items-center justify-start w-[37%] md:w-full">
                    <div className="flex flex-col items-center justify-start w-full">
                      <div className="flex flex-row gap-[22px] items-start justify-between w-full">
                        ...
                        <div className="font-sfprotext h-[76px] md:h-[95px] mt-[30px] relative w-[10%]">
                          <div className="absolute md:h-[38px] h-[76px] inset-[0] justify-center m-auto w-[57%]">
                            <Text
                              className="absolute bottom-[0] left-[0] md:text-3xl sm:text-[28px] text-[32px] text-black-900 text-center tracking-[-0.24px]"
                              size="txtSFProTextSemibold32"
                            >
                              -
                            </Text>
                            <Text
                              className="absolute inset-x-[0] mx-auto md:text-3xl sm:text-[28px] text-[32px] text-black-900 text-center top-[0] tracking-[-0.24px] w-max"
                              size="txtSFProTextSemibold32"
                            >
                              +
                            </Text>
          ...
          <div className="absolute bg-black-900_91 flex flex-col h-full inset-[0] items-center justify-center m-auto p-[214px] md:px-10 sm:px-5 w-full">
            <div className="bg-gray-100 flex flex-col items-center justify-start mb-[78px] mt-[26px] p-[88px] md:px-10 sm:px-5 rounded-[25px] w-[95%] md:w-full">
              <div className="flex flex-col md:gap-10 gap-[109px] items-center justify-start mb-[35px] mt-[19px] w-[97%] md:w-full">
                <Text
                  className="text-4xl sm:text-[32px] md:text-[34px] text-blue_gray-900 text-center tracking-[-0.24px] w-[97%] sm:w-full"
                  size="txtNunitoSansBold36"
                >
                  Are you sure you want to edit the Bill ?
                </Text>
                <div className="flex flex-row items-center justify-between w-full">
                  <Button
                    className="cursor-pointer font-bold leading-[normal] min-w-[177px] text-2xl md:text-[22px] text-center sm:text-xl tracking-[-0.24px]"
                    shape="round"
                    color="red_A700_01"
                  >
                    NO
                  ...
                  <Button
                    className="cursor-pointer font-bold leading-[normal] min-w-[185px] text-2xl md:text-[22px] text-center sm:text-xl tracking-[-0.24px]"
                    shape="round"
                    color="green_A700"
                  >
                    YES
