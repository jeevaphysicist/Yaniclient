...
const AddFarmProductsTwoPage = () => {
  ...
  const sideBarMenu = [
    ...
    },
    {
      ...
      label: (
        <Text className="mb-1.5 md:text-2xl sm:text-[22px] text-[26px] tracking-[-0.24px]">
          Add Farm Product
        </Text>
      ),
    ...
    },
    {
      ...
      label: (
        <>
          ...
          <Line className="bg-light_green-A700 h-[39px] mb-0.5 rotate-[-90deg] w-2" />
        </>
      ),
        ...
        <div className="flex md:flex-col flex-row gap-[26px] items-start justify-between mx-auto md:px-5 w-full">
          ...
          >
            ...
            <Menu
              ...
              className="flex flex-col font-nunitosans items-center justify-start mt-[76px] w-full"
            >
...
export default AddFarmProductsTwoPage;
