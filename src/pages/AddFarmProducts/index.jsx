  ...
  const sideBarMenu = [
    {
      ...
      label: <Text className="md:text-[22px] sm:text-xl">Dashboard</Text>,
      href: "/dashboardmain",
    ...
    },
    {
      ...
      label: (
        <Text className="mb-[5px] md:text-[22px] sm:text-xl tracking-[-0.24px]">
          Add Farm Product
        </Text>
      ),
      ...
      <div className="bg-gray-100 flex sm:flex-col md:flex-col flex-row font-bramptonserifregulardemo sm:gap-5 md:gap-5 items-start mx-auto w-full">
        ...
        >
          ...
          <Menu
            ...
            className="flex flex-col font-nunitosans items-center justify-start mt-[75px] w-full"
          >
          ...
          {!collapsed && (
            <div className="flex flex-row font-nunitosans gap-[27px] items-start justify-center ml-[38px] mr-[180px] mt-[327px] w-[39%]">
        ...
        <div className="flex-1 font-nunitosans h-[1024px] md:h-[987px] md:px-5 relative w-full">
          <div className="flex flex-col gap-[18px] h-full items-start justify-start m-auto w-[94%]">
            <Text
...
export default AddFarmProductsPage;
