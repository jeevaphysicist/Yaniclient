...
const AddFarmProductsOnePage = () => {
  ...
  const sideBarMenu = [
    ...
    },
    {
      ...
      label: (
        <Text className="mb-[3px] md:text-2xl sm:text-[22px] text-[26px] tracking-[-0.24px]">
          Add Farm Product
        </Text>
      ),
    ...
    },
    {
      ...
      label: (
        <>
          <Text className="md:text-2xl sm:text-[22px] text-[26px] tracking-[-0.24px]">
          ...
          <div className="flex flex-1 flex-col font-nunitosans gap-[18px] items-start justify-start md:mt-0 mt-[111px] w-full">
            ...
            <div className="bg-white-A700 flex flex-col font-sfprotext md:gap-10 gap-[71px] items-center justify-start p-[29px] sm:px-5 rounded-[25px] w-full">
              ...
              <div className="flex flex-col items-start justify-start mb-[34px] w-[90%] md:w-full">
                ...
                <div className="flex flex-row font-nunitosans items-start justify-between md:ml-[0] ml-[27px] mt-5 w-[92%] md:w-full">
                  <Text
                    className="mb-1 text-2xl md:text-[22px] text-gray-900_01 sm:text-xl"
                    size="txtNunitoSansSemiBold24"
                  >
                    Carrots
                  </Text>
                  <div className="h-[33px] md:h-[37px] my-0.5 relative w-[6%]">
                    <Text
                  ...
                  <Text
                    className="mt-1 text-2xl md:text-[22px] text-center text-gray-500 sm:text-xl tracking-[-0.24px]"
                    size="txtNunitoSansSemiBold24Gray500"
                  >
                    1000kg
                  </Text>
                  <Text
                    className="mt-[3px] text-2xl md:text-[22px] text-center text-gray-900_01 sm:text-xl tracking-[-0.24px]"
                    size="txtNunitoSansSemiBold24"
                  >
                ...
                <div className="font-nunitosans h-[361px] md:h-[362px] sm:h-[524px] mt-[11px] relative w-full">
                  <div className="absolute md:h-[298px] h-[303px] sm:h-[415px] inset-x-[0] mx-auto top-[0] w-full">
                    <div className="absolute bottom-[0] flex flex-col inset-x-[0] items-center justify-start mx-auto w-[92%]">
                      <div className="flex flex-col items-center justify-start w-full">
                        <div className="flex flex-row sm:gap-10 items-start justify-between w-full">
                          <Text
                            className="mb-[3px] text-2xl md:text-[22px] text-gray-900_01 sm:text-xl"
                            size="txtNunitoSansSemiBold24"
                          >
                            Garlic
                          </Text>
                        ...
                        <div className="flex flex-row sm:gap-10 items-start justify-between mt-[29px] w-full">
                          ...
                          <Text
                            className="mt-1 text-2xl md:text-[22px] text-center text-gray-900_01 sm:text-xl tracking-[-0.24px]"
                            size="txtNunitoSansSemiBold24"
                          >
                            <span className="text-gray-900_01 font-nunitosans font-semibold">
                              5,00,000
                        ...
                        <div className="flex flex-row sm:gap-10 items-start justify-between mt-[25px] w-full">
                          <Text
                            className="mb-2 text-2xl md:text-[22px] text-gray-900_01 sm:text-xl"
                            size="txtNunitoSansSemiBold24"
                          >
                            Corn
                          </Text>
                          <Text
                            className="mt-2 text-2xl md:text-[22px] text-center text-gray-900_01 sm:text-xl tracking-[-0.24px]"
                            size="txtNunitoSansSemiBold24"
                          >
                            <span className="text-gray-900_01 font-nunitosans font-semibold">
                              5,00,000
                    ...
                    <div className="absolute flex flex-col h-max inset-[0] justify-center m-auto w-full">
                      <div className="bg-gray-300_84 flex sm:flex-col flex-row sm:gap-5 items-start justify-start p-[3px] rounded-[10px] w-full">
                        <Text
                          className="mb-3.5 sm:ml-[0] ml-[23px] text-2xl md:text-[22px] text-gray-900_01 sm:text-xl"
                          size="txtNunitoMedium24"
                        >
                          Onion
                        </Text>
                        <Text
                          className="mb-[5px] sm:ml-[0] ml-[358px] sm:mt-0 mt-[9px] text-2xl md:text-[22px] text-center text-gray-500 sm:text-xl tracking-[-0.24px]"
                          size="txtNunitoSansSemiBold24Gray500"
                        >
                          500kg
                        </Text>
                        <Text
                          className="sm:ml-[0] ml-[159px] sm:mt-0 my-[7px] text-2xl md:text-[22px] text-center text-gray-900_01 sm:text-xl tracking-[-0.24px]"
                          size="txtNunitoSansSemiBold24"
                        >
                          <span className="text-gray-900_01 font-nunitosans font-semibold">
                            5,00,000{" "}
                      ...
                      <div className="flex flex-col gap-[34px] items-center justify-start md:ml-[0] ml-[450px] mt-4">
                        <Text
                      ...
                      <Text
                        className="md:ml-[0] ml-[444px] mt-7 text-2xl md:text-[22px] text-center text-gray-500 sm:text-xl tracking-[-0.24px]"
                        size="txtNunitoSansSemiBold24Gray500"
                      >
                        1000kg
                      </Text>
                  ...
                  <div className="absolute flex flex-col h-max inset-[0] items-center justify-center m-auto w-[92%]">
                    <div className="flex flex-col gap-7 justify-start w-full">
                      <div className="flex flex-col items-center justify-start md:ml-[0] ml-[226px]">
                        <Text
                          className="text-2xl md:text-[22px] text-center text-gray-500 sm:text-xl tracking-[-0.24px]"
                          size="txtNunitoSansSemiBold24Gray500"
                        >
                      ...
                      <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start w-full">
                        <Text
                          className="mb-[3px] text-2xl md:text-[22px] text-gray-900_01 sm:text-xl tracking-[-0.24px]"
                          size="txtNunitoSansSemiBold24"
                        >
                          Beetroot
                        </Text>
                        <Text
                          className="mb-[3px] sm:ml-[0] ml-[131px] text-2xl md:text-[22px] text-center text-gray-500 sm:text-xl tracking-[-0.24px]"
                          size="txtNunitoSansSemiBold24Gray500"
                        >
                          #01
                        </Text>
                        <Text
                          className="sm:ml-[0] ml-[154px] sm:mt-0 mt-[3px] text-2xl md:text-[22px] text-center text-gray-500 sm:text-xl tracking-[-0.24px]"
                          size="txtNunitoSansSemiBold24Gray500"
                        >
                          500kg
                        </Text>
                        <Text
                          className="sm:ml-[0] ml-[159px] text-2xl md:text-[22px] text-center text-gray-900_01 sm:text-xl tracking-[-0.24px]"
                          size="txtNunitoSansSemiBold24"
                        >
                          <span className="text-gray-900_01 font-nunitosans font-semibold">
                            5,00,000{" "}
                ...
                <Button
                  className="cursor-pointer font-semibold font-sfprotext leading-[normal] md:ml-[0] ml-[9px] mt-[76px] rounded-[13px] text-center text-xl tracking-[-0.24px] w-[210px]"
                  color="black_900"
                  variant="outline"
                >
                  Edit
...
export default AddFarmProductsOnePage;
