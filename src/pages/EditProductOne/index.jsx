...
const EditProductOnePage = () => {
  ...
  const sideBarMenu = [
    ...
    },
    {
      icon: (
        <Img
          className="h-[33px] mb-1.5 w-[33px]"
          src="images/img_television_blue_gray_900.svg"
          alt="television_One"
        />
      ),
      label: (
        <Text className="mb-1.5 md:text-[22px] sm:text-xl tracking-[-0.24px]">
          Add Farm Product
        </Text>
      ),
  ...
  return (
    <>
      <div className="bg-gray-100 flex sm:flex-col md:flex-col flex-row font-bramptonserifregulardemo sm:gap-5 md:gap-5 items-start mx-auto w-full">
        ...
        <div className="flex-1 font-nunitosans h-[1024px] md:h-[988px] md:px-5 relative w-full">
          <div className="flex flex-col gap-[19px] h-full items-start justify-start m-auto w-[94%]">
            <Text
...
export default EditProductOnePage;
